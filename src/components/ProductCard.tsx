...
export default function ProductCard({ product, quantity, onAdd, onRemove, isAdmin, onEdit, onDelete }: ProductCardProps) {
  return (
            ...
            {product.useImage && product.image ? (
              <img
                ...
                onError={(e) => {
                  ...
                  if (parent) parent.innerHTML = `<span class="text-4xl">${product.emoji}</span>`;
                }}
              />
            ) : (
