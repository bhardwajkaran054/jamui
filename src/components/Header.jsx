export default function Header({ cartCount, onCartClick, isAdmin }) {
  return (
        ...
        <div className="flex items-center gap-4">
          {isAdmin && (
            <button
              ...
              className="hidden sm:flex items-center gap-2 text-xs font-bold bg-green-700 hover:bg-green-600 px-3 py-2 rounded-full transition-all border border-green-600"
            >
              🛠️ ADMIN
            </button>
          )}
