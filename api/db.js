...
const DB_PATH = join('/tmp', 'jamui-db.json');
...
function getInitialDb() {
  return {
    ...
    orders: [],
    categories: ['Rice', 'Oil', 'Dal', 'Atta & Sugar'],
    admins: [{ id: 1, username: 'kbcode', password: bcrypt.hashSync('TjBraWE=', 10) }],
    stockLogs: [],
    drivers: [],
    promoCodes: [],
    notices: { text: '', active: false },
    deliveryZones: [],
    settings: {}
  };
}
